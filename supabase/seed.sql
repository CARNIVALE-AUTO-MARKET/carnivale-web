...
begin
  ...
  values
    (seller, 2011, 'Nissan', 'Frontier', 'SV', 19700, '1N6AD0EV5BC400001', '55403', 'standard', 14250, 'One-owner Frontier SV, garage-kept, all service records. Tow package, bed liner, new tires.', '{}', 'active'),
    ...
    (seller, 2016, 'Ford', 'F-150', 'XLT 4x4', 88400, '1FTEW1EF0GF600003', '55104', 'standard', 22500, '5.0L V8, crew cab, trailer brake controller, spray-in liner.', '{}', 'active'),
    ...
    (seller, 2015, 'Chevrolet', 'Corvette', 'Stingray Z51', 28100, '1G1YK2D70F5800005', '55405', 'standard', 44900, 'Z51 package, 7-speed manual, two sets of wheels. Adult-owned, never tracked.', '{}', 'active'),
    (seller, 2017, 'Chevrolet', 'Tahoe', 'LT', 96200, '1GNSKBKC5HR900006', '55102', 'standard', 27800, '3-row family hauler, rear entertainment, tow package, fresh brakes.', '{}', 'active'),
    ...
    (seller, 2014, 'Jeep', 'Wrangler', 'Sport 4x4', 79900, '1C4AJWAG0EL200008', '55411', 'standard', 19900, 'Hardtop + soft top, lift kit, 33s, well cared for.', '{}', 'active'),
    (seller, 2021, 'Tesla', 'Model 3', 'Long Range', 31200, '5YJ3E1EB0MF300009', '55401', 'standard', 32900, 'Dual motor AWD, premium interior, recent tires, clean Carfax.', '{}', 'active'),
